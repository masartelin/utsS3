            ...
            <div class="col-8 m-auto">
                <div class="card shadow p-3 mb-5 bg-body-tertiary rounded">
                    <div class="card-header">
                        <b>FORM Event manager</b>
                    </div>
                    <div class="card-body">
                        <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama event</label>
                                <input name="nama_event" type="text" class="form-control" id="exampleInputEmail1"
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Lokasi Event</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="jumlah_peserta" type="form-control" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                            </div>
